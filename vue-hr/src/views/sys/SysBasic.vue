<template>
    <div>
        <el-tabs v-model="activeName" type="card">
            ...
            <el-tab-pane label="职称管理" name="jolevelmana"><JoLevelMana></JoLevelMana></el-tab-pane>
...
<script>
    ...
    import JoLevelMana from '../../components/sys/basic/JoLevelMana'
    ...
    export default {
        ...
        data(){
            ...
            components:{
                DepMana, PosMana , JoLevelMana, EcMana, PermissMana
