    ...
    <div>
        ...
        <div style="margin-top: 8px">
            <el-table
                ...
                <template slot-scope="scope">
                    <el-button size="small" type="primary" icon="el-icon-edit" @click="showEditView(scope.row)">编辑</el-button>
                    <el-button size="" type="danger"  icon="el-icon-delete" @click="deleteHandler(scope.row)">删除</el-button>
                </template>
            </el-table-column>
            </el-table>
